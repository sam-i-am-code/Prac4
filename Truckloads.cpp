...
int Truckloads::numTrucks(int numCrates, int loadSize){//numCrates will be between 2 and 10,000, inclusive. loadSize will be be between 1 and (numCrates - 1), inclusive.
		/*
